...
namespace NightTask.TestCases
{
    class Task_1_2_3
    {
        ...
        public void Test_1_2_3()
        {
            ...
            action.MoveToElement(homePage.ourProducts).Perform();
            System.Threading.Thread.Sleep(500);
            homePage.silos.Click();
            ...
            String tabUrl;
            String subtabUrl;
            String tabName = "OUR PRODUCTS";
            String subtabName = "SILOS";
            ...
            Assert.IsTrue(res, "Actual page URL is not matched with expected: our-products/silos");
        }
