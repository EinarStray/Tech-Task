...
namespace NightTask.TestCases
{
    class Task_1_2_5
    {
        ...
        public void Test_1_2_5()
        {
            ...
            action.MoveToElement(homePage.workWithWabash).Perform();
            ...
            String tabUrl;
            String subtabUrl;
            String tabName = "WORK WITH WABASH";
            String subtabName = "MY HR";
            ...
            Assert.IsTrue(res, "Actual page URL is not matched with expected: work-with-wabash/my-hr");
        }
